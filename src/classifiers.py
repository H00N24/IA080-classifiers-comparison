...
layers = ((300, 100), (500, 300), (800,), (500, 500, 2000))
act_hidden = ("tanh", "sigmoid", "relu")
act_output = ("sigmoid", "softmax")
loss = ("mean_squared_error", "categorical_crossentropy")
networks = product(layers, act_hidden, act_output, loss)
